...
public protocol ArchiveInteractable: Interactable, AddArchiveListener, ArchiveSearchListener, ArchiveFolderListener, ArchiveFolderListener {
...
public final class ArchiveRouter: ViewableRouter<ArchiveInteractable, ArchiveViewControllable>, ArchiveRouting {
	...
	public func routeToAddArchive() {
		...
		let routing = addArchiveBuilder.build(withListener: interactor)
